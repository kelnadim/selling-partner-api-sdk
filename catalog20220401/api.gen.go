...
func NewSearchCatalogItemsRequest(endpoint string, params *SearchCatalogItemsParams) (*http.Request, error) {
	...
	if params.Identifiers != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "identifiers", *params.Identifiers); err != nil {
			return nil, err
	...
	if params.IdentifiersType != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", true, "identifiersType", *params.IdentifiersType); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.Keywords != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "keywords", *params.Keywords); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.BrandNames != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "brandNames", *params.BrandNames); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.ClassificationIds != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "classificationIds", *params.ClassificationIds); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
